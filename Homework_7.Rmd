...
iris %>%
  ...
  summarize(Mean.Width= mean(Sepal.Width), Mean.Length= mean(Sepal.Length), Mean.Area=mean(Sepal.Area), TotalNumber=n())
#now i need to get back to the previous pipe data
  
#iris %>%
#  pivot_longer(cols=Species:Sepal.Length:Sepal.Width, names_to="Species","Measure", "Value" , values_to= )

...
# output : the summary of the chi square pvalue
#------------------------------
chi2 <- function(data, null_col="Nulleyesize" , wt_col="WTeyesize")  {
  c_df<-chisq.test(data$null_col, data$wt_col, correct=FALSE)
summary(c_df)
...
# output: abox plot of the two catgories of eye
#------------------------------
